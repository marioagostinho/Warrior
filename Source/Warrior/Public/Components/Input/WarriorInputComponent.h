...
{
	checkf(InInputConfig, TEXT("BindNativeInputAction: Input config data asset is null, can not proceed with binding"));
...
{
	checkf(InInputConfig, TEXT("BindAbilityInputAction: Input config data asset is null, can not proceed with binding"));
